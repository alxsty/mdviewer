...
Maintenance release 3.1.6: corregge il refresh passivo del file collegato al ritorno in primo piano, evitando che il reader Markdown torni all’inizio dopo Alt+Tab o foreground su PWA.
